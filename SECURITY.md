...
If you discover a security vulnerability within Library@DR-Conversion, please send an email to security@example.com. All security vulnerabilities will be promptly addressed.
...
When using Library@DR-Conversion:
